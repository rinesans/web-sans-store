...
import { Crown, Shield, Zap, HelpCircle, ShoppingCart, CreditCard } from 'lucide-react';
         ...
         <div className="container mx-auto px-4">
            <div className="text-center space-y-8">
               ...
               <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button size="lg" className="text-lg px-8 py-6 bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition-all" onClick={scrollToProducts} aria-label="Scroll ke bagian produk">
               ...
               <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-16">
                  ...
                  <div className="text-center space-y-2">
                     ...
                     <h3 className="font-semibold text-primary dark:text-primary">QRIS</h3>
                     <p className="text-sm text-muted-foreground">Pembayaran mudah dengan QRIS</p>
                  </div>
